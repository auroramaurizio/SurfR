...
To do so, we use the SurfR built-in function **Enrichment**,  based on the [enrichR](https://cran.r-project.org/web/packages/enrichR/vignettes/enrichR.html) cran package (Kuleshov et al. 2016). 
...
obtained through EnrichR (Kuleshov et al. 2016) using ggplot2, with the built-in function 
**Enrichment_barplot**.
