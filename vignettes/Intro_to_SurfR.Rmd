...
A DEGs analysis can result in many upregulated genes and it may be difficult 
to choose the best surface marker candidatates. 
If you analyzed several datasets we always suggest to start taking a look at 
the DEGs in common beetween different sources with a simple, 
yet effective representation strategy such as the venn diagram.
