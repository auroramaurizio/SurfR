...
```{r TCGA THYM Download, warning=FALSE, message = FALSE, eval=FALSE}
# Download TCGA data
...
```{r TCGA BRCA Download, warning=FALSE, message = FALSE, eval=FALSE}
# Download TCGA data
# To save time only download 3 Tumor samples and 3 normal samples.
# If barcodes are not specified TCGA_download function will download all the 
# available samples in the TCGA study
...
```{r meta GEO_input metadata, eval = FALSE}
...
```{r meta GEO_input counts, eval = FALSE}
